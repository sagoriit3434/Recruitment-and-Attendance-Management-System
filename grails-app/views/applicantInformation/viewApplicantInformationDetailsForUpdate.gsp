...
<section class="content">
    <h3 align="center"> Yours Detail Information  </h3>
    <g:if test="${message}">
                    ...
                    <div class="box box-primary">
                        ...
                        <g:if test="${flag == true}">
                            <div class="box-footer">
                                <g:link class="btn btn-md btn-success pull-right"  controller="applicantInformation" action="updateApplicantInformationFrom" id="${applicantInformationInstance?.id}">
                                    <i class="fa fa-edit"></i><g:message code="default.button.show.label" default="Edit"/>
                                </g:link>
