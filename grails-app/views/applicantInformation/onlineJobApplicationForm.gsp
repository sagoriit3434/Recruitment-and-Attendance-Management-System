    ...
    <script type="text/javascript">
        ...
        function checkNumberAndDigitForHonors(input){
            ...
            if(input.length > 0 ){
                ...
                if((x.toString() == "NaN" || input.length > x.toString().length)&& input !='00'){
...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-10">
                <!-- Profile Image -->
                <g:form url="[resource: applicantInformationInstance, action: 'saveApplicantInformation']" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body box-profile">
                            ...
                            <input type="hidden" name="recruitmentDetails.id" value="${recruitmentDetailsInstance?.id}">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-footer">
                            <fieldset class="buttons">
                                <button type="submit" id="submitButton" class="btn btn-primary pull-right"><i class="fa fa-save"></i> ${message(code: "default.button.create.label1", default: "Submit")}</button>
                            </fieldset>
                        </div><!-- /.box-footer -->
