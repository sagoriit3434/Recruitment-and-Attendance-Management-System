    ...
    <div class="content-wrapper">
        ...
        <div class="box">
            <div class="box-header">
                <h3 align="center" style="font-weight: bold">Position List</h3>
                <g:if test="${message}">
            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <g:each in="${availAblePositionInstanceList}" status="i" var="availAblePositionInstance">
                        <tr>
                            <td> ${i+1}</td>
                            <td> ${availAblePositionInstance?.positionName}</td>
                            <td> ${availAblePositionInstance?.positionDetails}</td>
                            <td>

                                <g:link class="btn btn-xs btn-primary " action="editAvailablePositionTemplate" id="${availAblePositionInstance?.id}" target="_blank" params="[userId:user?.id]">
                                    <i class="fa fa-fw fa-edit"></i> <g:message code="default.button.show.label" default="Edit"/>
                                </g:link>

                                %{--<g:link class="btn btn-xs btn-warning" action="deleteAvailablePosition" id="${availAblePositionInstance?.id}" params="[userId:user?.id]">--}%
