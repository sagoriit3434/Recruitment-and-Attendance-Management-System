...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1 style="color:blue; text-align: center">Searching Position For Approved Applicant List</h1>
    ...
    %{--</section><!--Flash Message-->--}%
        ...
        <g:form method="get" action="availAblePositionForViewingApprovedApplicantList">
            ...
            <g:each in="${availablerecruitmentDetailsList}" status="i" var="recruitmentDetailsInstance">
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        <g:link class="btn btn-md btn-success pull-right" action="viewAllApprovedApplicantForARecruitDetails" id="${recruitmentDetailsInstance?.id}" params="[userId:user?.id]" target="_blank">
                            <i class="fa fa-eye" aria-hidden="true"></i>
                            <g:message code="default.button.show.label" default="View All Approved Applicant"/>
                        </g:link>
                    </div>
