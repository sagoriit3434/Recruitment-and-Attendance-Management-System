...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1 style="color: blue; text-align: center">${recruitmentDetails?.position?.positionName}</h1>
            <h4 style="color: blue; text-align: center">Recommendation</h4>
        </section><!-- /.content-header -->



        <g:form method="get" action="recommendationTemplateForAvailablePosition">
                ...
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="rid" value="${recruitmentDetails?.id}">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <g:if test="${ssc}">
                                            ...
                                            <input type="checkbox" style="height: 18px; width: 18px" name="ssc" checked="checked">

                                        </g:if>
                                        <g:else>
                                            <input type="checkbox" style="height: 18px; width: 18px" name="ssc">
                            ...
                            <div class='col-md-4'>
                                <div class="checkbox">
                                    <label>
                                        <g:if test="${hse}">
                                            <input type="checkbox" style="height: 18px; width: 18px" name="hse" checked="checked">



                                        </g:if>
                                        <g:else>
                                            <input type="checkbox" style="height: 18px; width: 18px" name="hse">
                            ...
                            <div class='col-md-4'>
                                <div class="checkbox">
                                    <label>
                                        <g:if test="${honor}">
                                            <input type="checkbox" style="height: 18px; width: 18px" name="honor" checked="checked">



                                        </g:if>
                                        <g:else>
                                            <input type="checkbox" style="height: 18px; width: 18px" name="honor">
                        ...
                        <div class="row">
                            ...
                            <div class='col-md-4'>
                                <div class="checkbox">
                                    <label>
                                        <g:if test="${ms}">
                                            <input type="checkbox" style="height: 18px; width: 18px" name="ms" checked="checked">


                                        </g:if>
                                        <g:else>
                                            <input type="checkbox" style="height: 18px; width: 18px" name="ms">
                            ...
                            <div class='col-md-4'>
                                <div class="checkbox">
                                    <label>
                                        <g:if test="${problemSolvingSkill}">
                                            <input type="checkbox" style="height: 18px; width: 18px" name="problemSolvingSkill" checked="checked">


                                        </g:if>
                                        <g:else>
                                            <input type="checkbox" style="height: 18px; width: 18px" name="problemSolvingSkill">
                            ...
                            <div class='col-md-4'>
                                <div class="checkbox">
                                    <label>
                                        <g:if test="${communicationSkill}">
                                            <input type="checkbox" style="height: 18px; width: 18px" name="communicationSkill" checked="checked">


                                        </g:if>
                                        <g:else>
                                            <input type="checkbox" style="height: 18px; width: 18px" name="communicationSkill">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <g:if test="${experience}">
                                            ...
                                            <input type="checkbox" style="height: 18px; width: 18px" name="experience" checked="checked">

                                        </g:if>
                                        <g:else>
                                            <input type="checkbox" style="height: 18px; width: 18px" name="experience">
            ...
            <div class="box box-primary">
                <div class="box-body table-responsive">
                    ...
                    <table class="table table-bordered table-striped table-hover table-condensed display nowrap th-center th-colored">
                        ...
                        <tbody>
                        <g:if test="${recommendedApplicant}">
                            <g:each in="${recommendedApplicant}" status="i" var="applicantInstance">
                                <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                    ...
                                    <td class="center">
                                        ...
                                        <g:if test="${applicantInstance?.approveIndicator == false}">
                                            <g:link class="btn btn-xs btn-primary" action="approvedApplicant" id="${applicantInstance?.id}" params="[userId:user?.id]">
                                                <i class="fa fa-fw fa-plus-square"></i> <g:message code="default.button.show.label" default="Approved"/>
                                            </g:link>

                                        </g:if>

                                        <g:link class="btn btn-xs btn-success" action="viewApplicantInformation" id="${applicantInstance?.id}" params="[userId:user?.id]">
                                        ...
                                        <g:if test="${applicantInstance?.discardIndicator == false}">
                                            <g:link class="btn btn-xs btn-danger" action="rejectApplicant" id="${applicantInstance?.id}" params="[userId:user?.id]">
