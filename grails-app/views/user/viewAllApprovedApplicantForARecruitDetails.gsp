...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <h4 style="text-align: center; color: blue">Approved Applicants List</h4>
...
<section class="content" id="hide_show">
<div class="box box-primary">
    <g:form method="post" action="sendEmail">
        <input type="hidden" name="userId" value="${user?.id}">
        <input type="hidden" name="rid" value="${recruitmentDetailsInstance?.id}">


        <div class="box-body">
            <div class="col-md-12">
                <g:textArea name="examCenter" class="form-control" placeholder="Enter exam center" rows="2" required="required"></g:textArea>

                %{--<g:textField name="examCenter" class="form-control" placeholder="Enter exam center"></g:textField>--}%
            </div>

            <div class="col-md-12">
                <h3 align="center"> Message </h3>
                <g:textArea name="message" id="textarea" required="" placeholder="Place some text here" style="width: 100%; height: 80px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></g:textArea>
        ...
        <div class="box-footer">
            <fieldset class="buttons">
                <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-envelope"></i> ${message(code: "default.button.create.lab1el", default: "Send Email")}</button>
            </fieldset>
        </div><!-- /.box-footer -->
            ...
            <div class="box box-primary">
                <div class="box-body table-responsive">
                    ...
                    <table class="table table-bordered table-striped table-hover table-condensed display nowrap th-center th-colored">
                        <thead>
                        <tr>
                            <th> <input type="checkbox" name="mainCheckBox" id="select_all" > </th>
                            ...
                            <th>${message(code: 'ssmBeneficiary.beneficiaryName.label1', default: 'Confirmed')}</th>
                        ...
                        <g:if test="${applicantList}">
                            <g:each in="${applicantList}" status="i" var="applicantInstance">
                                <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                    ...
                                    <td class="center">
                                        <g:if test="${applicantInstance?.indicatorForAdmitCard == true}">
                                            Yes
