                    ...
                    <g:each in="${userInstanceList}" status="i" var="userInstance">
                        <tr>
                            ...
                            <td>
                                ...
                                <g:link class="btn btn-xs btn-primary " action="viewMonthlyAttendance" id="${userInstance?.id}">
                                    <i class="fa fa-fw fa-edit"></i> <g:message code="default.button.show.label" default="View Monthly Attendance"/>
                                </g:link>
