                        ...
                        <g:form url="[action: 'saveAvailAblePosition']" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="box box-primary">
                                    <div class="box-body box-profile">
                                        ...
                                        <div class="fieldcontain ${hasErrors(bean: availAblePositionInstance, field: 'positionName', 'error')} required">
                                            ...
                                            <g:textField name="positionName" required="" value="${availAblePositionInstance?.positionName}" class="form-control" onblur="checkAvailAvalityOfPosition(this.value)"/>
                                        ...
                                        <div class="fieldcontain ${hasErrors(bean: availAblePositionInstance, field: 'positionDetails', 'error')} ">
                                            ...
                                            <g:textArea name="positionDetails" value="${availAblePositionInstance?.positionDetails}" class="form-control" rows="5"/>
                            ...
                            <div class="box-footer">
                                <fieldset class="buttons">
                                    <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-save"></i> ${message(code: "default.button.create.label1", default: "Add")}</button>
