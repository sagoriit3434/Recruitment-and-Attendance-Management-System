...
<div class="wrapper">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="${resource(dir: "dist/img", file: "user3-128x128.jpg")}" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="${resource(dir: "dist/img", file: "user4-128x128.jpg")}" class="img-circle" alt="User Image">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="${resource(dir: "dist/img", file: "user2-160x160.jpg")}" class="user-image" alt="User Image">
                            <span class="hidden-xs">Code Pierce</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <g:link controller="user" action="viewProfile"><i class="fa fa-circle-o"></i> View </g:link>

                        </li>

                        <li>
                            <g:link controller="user" action="editProfile"><i class="fa fa-circle-o"></i> Edit </g:link>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        %{--<li><a href="../../index.html"><i class="fa fa-circle-o"></i> View  </a></li>--}%
                        <li>
                            <g:link controller="user" action="addEmployee"><i class="fa fa-circle-o"></i> Add </g:link>

                        </li>

                        <li>
                            <g:link controller="user" action="listOfEmployee"><i class="fa fa-circle-o"></i> List </g:link>
                        </li>
                    </ul>
                </li>
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title" style="padding-left: 45%">Today's Attendance List </h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <g:each in="${attendanceInformation}" status="i" var="attendanceInformationInstance">
                    <tr>
                        <td> ${attendanceInformationInstance?.user?.firstName} ${attendanceInformationInstance?.user?.lastName}</td>
                        <td> ${attendanceInformationInstance?.user?.designation}</td>
                        <td> ${attendanceInformationInstance?.entryTime}</td>
                        <td> ${attendanceInformationInstance?.exitTime}</td>
                    </tr>
