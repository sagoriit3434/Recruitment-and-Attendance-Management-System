            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-8">
                        ...
                        <g:form url="[action: 'editAvailablePosition']" method="POST" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="box box-primary">
                                    <div class="box-header">
                                        <h3 style="text-align: center; color: blue">Update Position</h3>
                            ...
                            <div class="box-footer">
                                <fieldset class="buttons">
                                    <button type="submit" id="submitButton" class="btn btn-primary pull-right"><i class="icon-edit"></i> ${message(code: "default.button.create.label1", default: "Update")}</button>
