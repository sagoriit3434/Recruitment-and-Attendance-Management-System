...
<head>
    ...
    <link rel="stylesheet" href="${resource(dir: "plugins1/bootstrap-wysihtml5", file: "bootstrap3-wysihtml5.min.css")}">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-8">
                        ...
                        <g:form url="[resource: recruitmentDetailsInstance, action: 'saveRecruitmentDetails']" method="POST" enctype="multipart/form-data">
                            <div class="box-body">

                                <input type="hidden" name="userId" value="${user?.id}">

                                <g:render template="recruitmentDetailsTemplate"/>


                            </div><!-- /.box-body -->
                            <div class="box-footer">
                                <fieldset class="buttons">
                                    <button type="submit" class="btn btn-primary pull-right" id="submitButton"> <i class="fa fa-save"></i> ${message(code: "default.button.create.label1", default: "Add Details")}</button>
